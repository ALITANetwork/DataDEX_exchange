...
var BRS = (function(BRS, $, undefined) {
    ...
    $(".add_recipients").on("click", function(e) {
        ...
        if ($(".same_out_checkbox").is(":checked")) {
            if (multi_out_same_recipients < 128) {
                ...
                $(".total_amount_multi_out").html(BRS.formatAmount(BRS.convertToNQT(total_multi_out)) + " ALITA");
            }
        } else {
    ...
    $("#multi_out_fee").on("change", function(e) {
        ...
        $(".total_amount_multi_out").html(BRS.formatAmount(BRS.convertToNQT(amount_total + fee)) + " ALITA");
    });
    ...
    $(".modal").on("hidden.bs.modal", function(e) {
        ...
        if ($feeInput.length) {
            ...
            $(this).find(".advanced_fee").html(BRS.formatAmount(BRS.convertToNQT(defaultFee)) + " ALITA");
        }
    ...
    $("input[name=feeNXT]").on("change", function() {
        ...
        if ($feeInfo.length) {
            $feeInfo.html(BRS.formatAmount(BRS.convertToNQT($(this).val())) + " ALITA");
        }
    });

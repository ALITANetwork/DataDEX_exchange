...
var BRS = (function(BRS, $, undefined) {
    ...
    BRS.getMarketplacePurchaseHTML = function(purchase, showBuyer) {
        ...
        return "<div data-purchase='" + String(purchase.purchase).escapeHTML() + "'" + (purchase.unconfirmed ? " class='tentative'" : "") + "><div style='float:right;color: #999999;background:white;padding:5px;border:1px solid #ccc;border-radius:3px'>" +
            ...
            "<tr><td><strong>" + $.t("price") + "</strong>:</td><td>" + BRS.formatAmount(purchase.priceNQT) + " ALITA</td></tr>" +
        ...
        if (unconfirmedTransactions) {
            for (var i = 0; i < unconfirmedTransactions.length; i++) {
                ...
                rows += "<tr class='tentative' data-goods='"
                    ...
                    + " ALITA</td><td style='white-space:nowrap'><a class='btn btn-xs btn-default' href='#' data-toggle='modal' data-target='#dgs_price_change_modal' data-goods='"
    ...
    BRS.forms.dgsPriceChangeComplete = function(response, data) {
        ...
        $("#my_dgs_listings_table tr[data-goods=" + String(data.goods).escapeHTML() + "]").addClass("tentative").find(".price").html(BRS.formatAmount(data.priceNQT) + " ALITA");
    };
            ...
            if (response.errorCode) {
                ...
                BRS.sendRequest("getDGSGood", {
                    ...
                    offset: {
                        ...
                        output += "<tr><th><strong>" + $.t("price") + "</strong>:</th><td>" + BRS.formatAmount(response.priceNQT) + " ALITA</td></tr>";
                        ...
                        if (type == "dgs_refund_modal" || type == "dgs_delivery_modal" || type == "dgs_feedback_modal") {
                            ...
                            if (response.quantity != "1") {
                                ...
                                output += "<tr><th><strong>" + $.t("total") + "</strong>:</th><td>" + orderTotal + " ALITA</td></tr>";
                            }
                            if (response.discountNQT && (type == "dgs_refund_modal" || type == "dgs_feedback_modal")) {
                                output += "<tr><th><strong>" + $.t("discount") + "</strong>:</th><td>" + BRS.formatAmount(response.discountNQT) + " ALITA</td></tr>";
                            }
                        }
                        ...
                        if (type == "dgs_view_refund_modal") {
                            output += "<tr><th><strong>" + $.t("refund_price") + "</strong>:</th><td>" + BRS.formatAmount(response.refundNQT) + " ALITA</td></tr>";
                        }
    ...
    $("#dgs_product_modal, #dgs_delisting_modal, #dgs_quantity_change_modal, #dgs_price_change_modal, #dgs_purchase_modal").on("show.bs.modal", function(e) {
        ...
        BRS.sendRequest("getDGSGood", {
            ...
            if (type == "dgs_quantity_change_modal") {
                ...
                $("#dgs_total_purchase_price").html(BRS.formatAmount(response.priceNQT) + " ALITA");
                ...
                $("#dgs_purchase_quantity").on("change", function() {
                    ...
                    $("#dgs_total_purchase_price").html(BRS.formatAmount(totalNQT) + " ALITA");
                });
            }
        }, false);
    }).on("hidden.bs.modal", function(e) {
    ...
    $("#dgs_clear_results").on("click", function(e) {
        ...
        $(".dgs_search input[name=q]").val("").trigger("unmask").mask("ALITA-****-****-****-*****", {
            "unmask": false
        });

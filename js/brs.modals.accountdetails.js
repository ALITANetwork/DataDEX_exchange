...
var BRS = (function(BRS, $, undefined) {
	...
	if (BRS.accountInfo.errorCode && BRS.accountInfo.errorCode != 5) {
	    ...
	    if (BRS.accountInfo.errorCode && BRS.accountInfo.errorCode == 5) {
		$("#account_balance_balance, #account_balance_unconfirmed_balance, #account_balance_effective_balance, #account_balance_guaranteed_balance").html("0 ALITA");
		...
		$("#account_balance_balance").html(BRS.formatAmount(new BigInteger(BRS.accountInfo.balanceNQT)) + " ALITA");
		$("#account_balance_unconfirmed_balance").html(BRS.formatAmount(new BigInteger(BRS.accountInfo.unconfirmedBalanceNQT)) + " ALITA");
		$("#account_balance_effective_balance").html(BRS.formatAmount(BRS.accountInfo.effectiveBalanceALITA) + " ALITA");
		$("#account_balance_guaranteed_balance").html(BRS.formatAmount(new BigInteger(BRS.accountInfo.guaranteedBalanceNQT)) + " ALITA");
